...
/// Create a copy of HassService
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = freezed,Object? description = null,Object? target = freezed,Object? fields = null,Object? response = freezed,}) {
  return _then(_self.copyWith(
...
class _HassService implements HassService {
  const _HassService({this.name, required this.description, final  Map<String, dynamic>? target, required final  Map<String, Field> fields, this.response}): _target = target,_fields = fields;
...
/// Create a copy of HassService
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = freezed,Object? description = null,Object? target = freezed,Object? fields = null,Object? response = freezed,}) {
