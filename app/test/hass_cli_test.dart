...
void main() {
  test(
    'HassTokenManager should create and delete long-lived access token',
    skip: 'This test only for debug purpose',
    () async {
  ...
  test(
    'HassTokenManager should delete existing Hommie client token',
    skip: 'This test only for debug purpose',
    () async {
      final manager = HassTokenManager();
