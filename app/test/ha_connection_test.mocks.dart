...
class _FakeHASocket_0 extends _i1.SmartFake implements _i2.HASocket {
  _FakeHASocket_0(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}

class _FakeStreamSink_1<S> extends _i1.SmartFake implements _i3.StreamSink<S> {
  _FakeStreamSink_1(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
class MockHASocket extends _i1.Mock implements _i2.HASocket {
  ...
  @override
  _i3.Stream<_i4.HASocketState> get stateStream =>
      (super.noSuchMethod(
            Invocation.getter(#stateStream),
            returnValue: _i3.Stream<_i4.HASocketState>.empty(),
          )
          as _i3.Stream<_i4.HASocketState>);

  @override
  _i4.HASocketState get state =>
      (super.noSuchMethod(
            Invocation.getter(#state),
            returnValue: _i5.dummyValue<_i4.HASocketState>(
              this,
              Invocation.getter(#state),
            ),
          )
          as _i4.HASocketState);

  @override
  _i3.Stream<dynamic> get stream =>
      (super.noSuchMethod(
...
class MockHAConnectionOption extends _i1.Mock
  ...
  @override
  _i3.Future<_i2.HASocket> createSocket() =>
      (super.noSuchMethod(
            Invocation.method(#createSocket, []),
            returnValue: _i3.Future<_i2.HASocket>.value(
              _FakeHASocket_0(this, Invocation.method(#createSocket, [])),
            ),
          )
...
class MockStreamController<T> extends _i1.Mock
  ...
  @override
  _i3.StreamSink<T> get sink =>
      (super.noSuchMethod(
            Invocation.getter(#sink),
            returnValue: _FakeStreamSink_1<T>(this, Invocation.getter(#sink)),
          )
          as _i3.StreamSink<T>);
...
class MockStreamSubscription<T> extends _i1.Mock
  ...
  @override
  _i3.Future<E> asFuture<E>([E? futureValue]) =>
      (super.noSuchMethod(
